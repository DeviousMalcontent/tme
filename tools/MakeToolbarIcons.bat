...
ECHO App Icon
ImageMagick\convert -size 256x256 xc:#00E5E5 -fill white -stroke black -draw "rectangle 0,0 32,32" -draw "rectangle 0,32 32,64" -draw "rectangle 0,96 32,64" -draw "rectangle 0,128 32,96" -draw "rectangle 0,160 32,128" -draw "rectangle 0,192 32,160" -draw "rectangle 0,224 32,192" -draw "rectangle 0,256 32,224" -draw "rectangle 32,0 64,32" -draw "rectangle 32,96 64,128" -draw "rectangle 32,128 64,160" -draw "rectangle 32,160 64,192" -draw "rectangle 32,192 64,224" -draw "rectangle 32,224 64,256" -draw "rectangle 64,0 96,32" -draw "rectangle 64,96 96,128" -draw "rectangle 64,128 96,160" -draw "rectangle 64,160 96,192" -draw "rectangle 64,192 96,224" -draw "rectangle 64,224 96,256" -draw "rectangle 96,0 64,32" -draw "rectangle 96,96 64,128" -draw "rectangle 96,128 64,160" -draw "rectangle 96,160 64,192" -draw "rectangle 96,192 64,224" -draw "rectangle 96,224 64,256" -draw "rectangle 128,0 96,32" -draw "rectangle 128,224 96,256" -draw "rectangle 160,0 128,32" -draw "rectangle 160,224 128,256" -draw "rectangle 192,0 160,32" -draw "rectangle 192,96 160,128" -draw "rectangle 192,128 160,160" -draw "rectangle 192,160 160,192" -draw "rectangle 192,192 160,224" -draw "rectangle 192,224 160,256" -draw "rectangle 224,0 192,32" -draw "rectangle 224,96 192,128" -draw "rectangle 224,128 192,160" -draw "rectangle 224,160 192,192" -draw "rectangle 224,192 192,224" -draw "rectangle 224,224 192,256" -draw "rectangle 256,0 224,32" -draw "rectangle 256,32 224,64" -draw "rectangle 256,64 224,96" -draw "rectangle 256,96 224,128" -draw "rectangle 256,128 224,160" -draw "rectangle 256,160 224,192" -draw "rectangle 256,192 224,224" -draw "rectangle 256,224 224,256" ..\res\appicon.png
ImageMagick\convert ..\res\appicon.png -define icon:auto-resize="256,128,96,64,48,32,16" -compress none ..\res\tilemapeditor.ico
PAUSE
